---
name: house-style
description: 'The house style for summaries: title length, key point count and form, numbers kept verbatim.'
---

# house-style

How every summary this harness produces is written. The validator checks the
two countable rules; the rest is what a reviewer reads for.
